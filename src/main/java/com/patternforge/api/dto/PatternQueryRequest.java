 ...
 * @param remainingContextTokens  optional: how many tokens remain in the agent's context window;
 *                                when provided, the effective token budget is capped to a fraction
 *                                of this value (see {@code patternforge.retrieval.adaptive-context-fraction})
 */
public record PatternQueryRequest(
        ...
        Integer topK,
        Integer remainingContextTokens) {}
